...
//         skill.Use(_fighter, new List<IUnitSystem> { target }, null);
...
//         skill.Use(_fighter, new List<IUnitSystem> { _fighter, ally1, ally2 }, null);
...
//         skill.Use(_fighter, new List<IUnitSystem> { enemy1, enemy2, enemy3 }, null);
