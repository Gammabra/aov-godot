...
public partial class InteractionComponentTest
{
    ...
    private InteractionComponent CreateComponent(out Sprite3D sprite)
    {
        ...
        component.Set("_spritePath", sprite.GetPath());
    ...
    {
        InteractionComponent component = CreateComponent(out Sprite3D sprite);
