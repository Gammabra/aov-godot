...
/// </remarks>
public abstract partial class MapSystem : GridMap, IMapSystem
{
    ...
    /// </summary>
    public int Width => GetUsedSize().Item1;

    /// <summary>
    ///     The total Y axis of the map (in number of cells)
    /// </summary>
    public int Height => GetUsedSize().Item2;

    /// <summary>
    ///     The total Z axis of the map (in number of cells)
    /// </summary>
    public int Depth => GetUsedSize().Item3;
