...
public abstract partial class MapSystem
{
    ...
    /// </remarks>
    public abstract void PlaceUnits(List<IUnitSystem> playerUnits, List<IUnitSystem> enemyUnits);
    ...
    /// </remarks>
    public virtual void MoveUnit(IUnitSystem unit, int newX, int newY, int newZ)
    {
    ...
    /// </returns>
    public virtual IUnitSystem? GetUnitAt(int x, int y, int z)
    {
