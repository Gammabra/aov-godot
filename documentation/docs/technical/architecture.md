...
This document outlines the software architecture for **Ashes of Velsingrad**, a Godot 4.4.1 C# (.NET 9.0) game project. Understanding this architecture will help you navigate the codebase, make informed decisions, and contribute effectively to the project.
...
- **Engine**: Godot 4.4.1 (Mono version)
- **Language**: C# (.NET 9.0)
