...
public class EnemyAIManagerTest
{
	...
	public void SetMapSystem_StoresMapReference()
	{
		...
		// Use reflection to verify the MapSystem was stored
	...
	public void SetUnitReferences_StoresPlayerUnits()
	{
		...
		var playerUnits = new List<UnitSystem> { playerUnit };
		var enemyUnits = new List<UnitSystem>();
		...
		var field = typeof(EnemyAIManager).GetField("_playerUnits",
			BindingFlags.NonPublic | BindingFlags.Instance);
		var storedPlayers = (List<UnitSystem>?)field?.GetValue(aiManager);
	...
	public void SetUnitReferences_StoresEnemyUnits()
	{
		...
		var playerUnits = new List<UnitSystem>();
		var enemyUnits = new List<UnitSystem> { enemyUnit };
		...
		var field = typeof(EnemyAIManager).GetField("_enemyUnits",
			BindingFlags.NonPublic | BindingFlags.Instance);
		var storedEnemies = (List<UnitSystem>?)field?.GetValue(aiManager);
